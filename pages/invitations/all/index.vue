      ...
      <form class="profile">
        ...
        <div class="col-12 control">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mt-2">
              <label for="filter_chair">{{ $t("chair_category") }}</label>
              <div class="mt-2">
                <select name="filter_chair" id="" v-model="filter_chair">
                    <option :value="``" >{{ $t("All") }}</option>
        ...
        <div class="col-12 list">
           <table>
              ...
              <tr v-for="item in filterByName" :key="item.id">
                <td>{{item.date}}</td>
                <td>{{item.full_name}}</td>
                <td>{{item.whatsapp_num}}</td>
                <td>{{item.email}}</td>
                <td>{{item.chair.class}}</td>
...
export default {
  ...
  components: {
   ...
   ...mapGetters({
      ...
      if (this.filter_chair != '') {
        return this.invitations.filter((item) => {
          return this.filter_chair
                       .toLowerCase()
                       .split(" ")
                       .every((v) => item.chair.grade == v);
                }) 
      }
